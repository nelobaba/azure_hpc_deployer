...
#   3. Deploy the sample application (app-argocd.yaml) through ArgoCD.
...
APP_NAMESPACE="${APP_NAMESPACE:-webapp}"
ARGOCD_MANIFEST="${ARGOCD_MANIFEST:-https://raw.githubusercontent.com/argoproj/argo-cd/stable/manifests/install.yaml}"

# Path to the ArgoCD Application manifest (defaults to the one next to this script).
...
# ----------------------------------------------------------------------------
# 3. Deploy the sample application through ArgoCD
# ----------------------------------------------------------------------------
