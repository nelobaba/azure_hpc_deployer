...
az group create -n "$AKS_RG" -l canadacentral
...
# Configure secret provider class to get secret from Keyvault using user managed identity
...
# Verify the secret is mounted inside the pod
